...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pLB6tE6ntT', 0, 'lz83XjuW2SEf19gX1R8XOK', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('lfarant01@gmail.com');
        $a->setPassword('ADE_et_IAN01');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hm+GgvbCAt', 0, 'lz83XjuW2SEf19gX1R8XOK', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5993ee93079959.89870426')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'lfarant01@gmail.com',
            'mailer_password' => 'ADE_et_IAN01',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'lfarant01@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'ADE_et_IAN01',

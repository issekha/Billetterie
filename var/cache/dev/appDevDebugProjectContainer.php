...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pLB6tE6ntT', 0, 'b5aXdZ6BxUdN0Qc9fnTT-e', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hm+GgvbCAt', 0, 'b5aXdZ6BxUdN0Qc9fnTT-e', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('599ef13d044696.88824591')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'stripe_key' => NULL,
            'stripe_private_key' => 'sk_test_8vdRwzS3fzDSSYAyG6I8VQir',
            'stripe_public_key' => 'pk_test_JnHnHbzCKM5CxeKzQyI3YfWk',
            'locale' => 'en',
